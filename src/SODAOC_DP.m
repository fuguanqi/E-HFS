...
for rr=1:repeat
    for n_S=n_S_array
        for n=n_array
            ...
            [xbest, fbest]=miso('datainput_dp',Iteration, 'rbf_c', [], 'slhd', 'soda_adm_fu',[],Data); %the new SODA-ADM
              writematrix(xbest,strcat('datainput_dp/best_X_n',num2str(Data.prob.n),'_',num2str(Data.prob.n_S)), 'WriteMode','append');
